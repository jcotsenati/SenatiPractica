...
namespace WindowsFormsApp3 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuarioRow AddUsuarioRow(string usuario, string contrasenia) {
...
SELECT id, dni, nombres, apellidos FROM Alumno WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT nombres, apellidos FROM dbo.Alumno";
        ...
        public virtual int FillByTest(DataSet1.AlumnoDataTable dataTable) {
        ...
        public virtual DataSet1.AlumnoDataTable GetDataByTest() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.AlumnoDataTable dataTable = new DataSet1.AlumnoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuario] WHERE (([id] = @Original_id) AND ([usuario] = @Origin" +
                "al_usuario) AND ([contrasenia] = @Original_contrasenia))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([usuario], [contrasenia]) VALUES (@usuario, @contras" +
                "enia);\r\nSELECT id, usuario, contrasenia FROM Usuario WHERE (id = SCOPE_IDENTITY(" +
                "))";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [usuario] = @usuario, [contrasenia] = @contrasenia WHE" +
                "RE (([id] = @Original_id) AND ([usuario] = @Original_usuario) AND ([contrasenia]" +
                " = @Original_contrasenia));\r\nSELECT id, usuario, contrasenia FROM Usuario WHERE " +
                "(id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, usuario, contrasenia FROM dbo.Usuario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_usuario, string Original_contrasenia) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string usuario, string contrasenia, int Original_id, string Original_usuario, string Original_contrasenia, int id) {
            if ((usuario == null)) {
                throw new global::System.ArgumentNullException("usuario");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string usuario, string contrasenia, int Original_id, string Original_usuario, string Original_contrasenia) {
            return this.Update(usuario, contrasenia, Original_id, Original_usuario, Original_contrasenia, Original_id);
        }
    }
